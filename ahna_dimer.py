...
import psfGen 
#============================== num_segid ======================================
num_segid = 2 # number of monomers
#======================== Create the PSF File ==================================
...
f = open('temp.pdb', 'w') # duplicated pdb dataset 
f.write(content)
f.close()
...
# short distant restraints
from noePotTools import create_NOEPot
if os.path.exists('noe.tbl'):

    # Copy the content of source to destination
    f = open("noe.tbl", 'r')
    lines = f.readlines() # ['assign ( resid    2 and name HB2* ) ( resid    2 and name  HA* )  2.80  1.00  0.00\n', 'assign ( resid    2 and name HB2* ) ( resid    2 and name  HA* )  2.80  1.00  0.00\n', 'assign ( resid    2 and name HB2* ) ( resid    2 and name  HA* )  2.80  1.00  0.00\n']
    f.close()
    ...
    noe.setPotType("soft")
    potList.append(noe)
    rampedParams.append(MultRamp(1.0,30.0, "noe.setScale( VALUE )"))
                                #1.0, 15.0
...
# alt.tbl are the distant restraints
    ...
    noe.setPotType("soft")
    potList.append(alt)
    rampedParams.append(MultRamp(0.5, 40.0,  "alt.setScale( VALUE )"))
                                #0.5, 20.0
#========================= Dihedral Potential =================================#
